...
public class Trans2PinYin {
     ...
     * @return 
     */  
    public String convertAll(String str) throws UnsupportedEncodingException {
        String result = "";  
        String strTemp = null;  
    ...
    public String getSelling(String chs) throws UnsupportedEncodingException {
        String key, value;  
    ...
    public String getSpelling() throws UnsupportedEncodingException {
     ...
     * @return 
     */  
    public static String trans2PinYin(String str) throws UnsupportedEncodingException {
