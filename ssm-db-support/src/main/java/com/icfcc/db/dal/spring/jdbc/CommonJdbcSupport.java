...
import com.icfcc.db.dal.descriptor.resolver.JavaTypeConversion;
import com.icfcc.db.dal.descriptor.resolver.JavaTypeResolver;
import com.icfcc.db.dal.spring.jdbc.model.ModifyParams;
import org.apache.commons.lang3.StringUtils;
import com.icfcc.db.dal.spring.jdbc.template.SqlTemplate;
...
public class CommonJdbcSupport extends JdbcDaoSupport {
    ...
    private Object[] buildParameters(Map<String, Object> params) {
        Object[] objs = null;
    ...
    private Object[] buildPrimaryKeyParameters(final Table table) {
        Object[] objs = null;
        Map<String, Object> params = table.getConditions();
...
//        return getJdbcTemplate().queryForInt(sql, buildParameters(table.getConditions()));
    ...
    private ModifyParams buildInsertParameters(Table table) {
        ...
        Object[] params = null;
        int[] types = null;
        Map<String, Object> paramsMap = table.getParams();
        if (paramsMap != null) {
    ...
    private ModifyParams buildUpdateParameters(Table table) {
        ...
        int[] types = null;
        Map<String, Object> paramsMap = table.getParams();
        Map<String, Object> conditionsMap = table.getConditions();
        int index = 0;
        modifyParams = new ModifyParams();
        if (paramsMap != null) {
            params = new Object[paramsMap.size()];
    ...
    public int updateByPrimaryKey(Table table) {
        ...
        return this.getJdbcTemplate().update(sql, modifyParams.getParams(), modifyParams.getTypes());
    }
    ...
    private ModifyParams buildUpdateByPrimaryKey(Table table) {
        ...
        if (paramsMap != null) {
            ...
            types = new int[size];
            Set<Entry<String,Object>> entrys = paramsMap.entrySet();
