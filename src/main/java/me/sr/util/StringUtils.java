...
/**
 * Created by wanghuanyu on 2015/5/11.
 */
public class StringUtils {
     ...
     * @param index     the index in the original string to init matching against
     ...
     *
     * @param path         the path to init from (usually a full file path)
     ...
     * @param prefix the String to init each element with
